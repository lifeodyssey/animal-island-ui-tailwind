...
const DividerFooterSection = () => (
    <section data-testid="divider-footer-region" style={sectionStyle}>
        ...
        <div data-testid="footer-matrix" style={{ ...panelStyle, display: 'grid', gridTemplateColumns: '1fr', gap: 16 }}>
            <div>
                <div style={{ color: '#725d42', fontSize: 13, fontWeight: 700, marginBottom: 8 }}>all icons</div>
                <Footer className="parity-footer-all" style={{ width: 520 }} />
            </div>
            <div>
                <div style={{ color: '#725d42', fontSize: 13, fontWeight: 700, marginBottom: 8 }}>single icon</div>
                <Footer name="Heart" className="parity-footer-single" style={{ width: 520 }} />
            </div>
        </div>
    </section>
);
