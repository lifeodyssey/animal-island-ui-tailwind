/**
 * Animal Island organic-blob clip-path.
 *
 * An `objectBoundingBox`-normalized SVG path describing the signature
 * organic blob silhouette shared by the Modal and the island Tooltip.
 * Kept in one place so both clips stay pixel-identical.
 */
export const ISLAND_BLOB_PATH =
