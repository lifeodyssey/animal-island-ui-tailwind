...
const VT_CLASS: Record<SkeletonVariant, string> = {
    text: 'animal-skeleton-vt-text',
    circle: 'animal-skeleton-vt-circle',
    rect: 'animal-skeleton-vt-rect',
    paragraph: 'animal-skeleton-vt-paragraph',
};
...
export const Skeleton: React.FC<SkeletonProps> = ({
    ...
    if (variant === 'circle') {
        ...
        return <div className={baseCls} style={{ width: size, height: size, ...style }} aria-hidden />;
    }
