            ...
            <div className="animal-carousel-viewport">
                {slides.map((slide, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={cn('animal-carousel-slide', active && 'animal-carousel-active')}
                            role="group"
            ...
            {hasControls && showArrows && (
                <>
                    <button
                        type="button"
                        className={cn(
                            'animal-carousel-arrow',
                            'animal-carousel-prev',
                            !loop && currentIndex === 0 && 'animal-carousel-arrow-disabled'
                        )}
                        aria-label="上一张"
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            !loop && currentIndex === lastIndex && 'animal-carousel-arrow-disabled'
                        )}
                        aria-label="下一张"
