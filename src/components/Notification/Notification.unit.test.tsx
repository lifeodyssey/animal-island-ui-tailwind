...
describe('Notification', () => {
    ...
    describe('destroy + closeIcon race fix', () => {
        it('destroy 后同 key 后续 open 不再创建（dismissed 闭包经 onClose 收到信号）', async () => {
        ...
        it('closeIcon span onClick 置 dismissed 后，后续 open 不复活（race 修复验证）', async () => {
            const user = userEvent.setup();
