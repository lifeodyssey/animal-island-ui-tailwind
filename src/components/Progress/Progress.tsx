...
const SIZE_TRACK_CLASS: Record<ProgressSize, string> = {
...
export const Progress: React.FC<ProgressProps> = ({
    ...
    const trackCls = cn('animal-progress-track', SIZE_TRACK_CLASS[size]);
    const fillCls = cn('animal-progress-fill', duration === 0 && 'animal-progress-fill-no-transition');
    const bodyCls = cn(
        'animal-progress-body',
        infoPosition !== 'top' && 'animal-progress-body-no-gap'
    );
