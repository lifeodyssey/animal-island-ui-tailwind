...
const TRACK_SIZE_CLASS: Record<ProgressSize, string> = {
...
export const Progress: React.FC<ProgressProps> = ({
    ...
    const ariaValueText = showInfo && typeof renderedInfo === 'string' ? renderedInfo : undefined;
    ...
    const infoInsideNode = isInside && !infoInsideVisible ? (
        <span className="animal-progress-info-inside" style={{ color: '#725d42' }}>{renderedInfo}</span>
    ) : null;
