...
export const Progress: React.FC<ProgressProps> = ({
    ...
    const fillCls = cn('animal-progress-fill', duration === 0 && 'animal-progress-no-transition');
    const bodyCls = cn('animal-progress-body', infoPosition !== 'top' && 'animal-progress-no-gap');
