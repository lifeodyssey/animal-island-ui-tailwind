...
describe('Progress', () => {
    ...
    describe('size', () => {
        it('size=small applies animal-progress-size-small class to track', () => {
        ...
        it('size=middle applies animal-progress-size-middle class to track (default)', () => {
            const { container } = render(<Progress percent={50} />);
            expect(container.querySelector('.animal-progress-size-middle')).toBeInTheDocument();
        });

        it('size=large applies animal-progress-size-large class to track', () => {
    ...
    describe('animation', () => {
        ...
        it('default fill carries the stripe animation class', () => {
            const { container } = render(<Progress percent={50} />);
            const fillEl = container.querySelector('.animal-progress-fill') as HTMLElement;
            expect(fillEl).toBeInTheDocument();
