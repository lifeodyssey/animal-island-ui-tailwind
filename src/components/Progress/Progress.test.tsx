...
describe('Progress', () => {
    describe('rendering', () => {
        ...
        it('forwards className and style', () => {
            ...
            expect(root).toHaveClass('animal-progress');
    ...
    describe('animation', () => {
        ...
        it('fill carries the animal-progress-fill class', () => {
            const { container } = render(<Progress percent={50} />);
            const fillEl = container.querySelector('.animal-progress-fill') as HTMLElement;
            expect(fillEl).toBeInTheDocument();
        });
    ...
    describe('inside info fallback for low percent', () => {
        it('shows percent outside fill when percent < 18 to keep text readable', () => {
