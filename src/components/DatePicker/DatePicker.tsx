    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="animal-datepicker-icon" aria-hidden>
                                    ...
                                    {MONTHS.map((label, i) => {
                                        ...
                                        return (
                                            <button
                                                key={label}
                                                type="button"
                                                className={cn('animal-datepicker-month-cell', selected && 'animal-datepicker-month-selected')}
                                                aria-label={`${i + 1}月`}
                                                onClick={() => {
                                                    if (picker === 'month' && !range) {
                                    ...
                                    {yearCells.map((y) => {
                                        ...
                                        return (
                                            <button
                                                key={y}
                                                type="button"
                                                className={cn('animal-datepicker-year-cell', selected && 'animal-datepicker-year-selected')}
                                                aria-label={`${y}年`}
                                                onClick={() => {
