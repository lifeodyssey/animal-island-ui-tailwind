    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="animal-date-picker-icon" aria-hidden>
            ...
            {open && (
                <div
                    ...
                    className={cn(
                        ...
                        closing
                            ? 'animal-date-picker-panel-closing'
                            : mounted
                              ? 'animal-date-picker-panel-visible'
                              : ''
                    )}
                    style={panelStyle}
                >
                                                ...
                                                <div className="animal-date-picker-header-group">
                                                    {idx === 0 && (
                                                        <button
                                                            ...
                                                            onMouseDown={(e) => e.preventDefault()}
                                                        >
                                                            <img src={iconLeft} className="animal-date-picker-nav-icon" alt="" />
                                                        </button>
                                                    )}
                                                    {idx === 0 && (
                                                        <button
                                                ...
                                                <div className="animal-date-picker-header-group">
                                                    ...
                                                    {idx === 1 && (
                                                        <button
                                                            ...
                                                            onMouseDown={(e) => e.preventDefault()}
                                                        >
                                                            <img src={iconRight} className="animal-date-picker-nav-icon" alt="" />
                                                        </button>
                                                    )}
                                                </div>
                                            </div>
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    sel && 'animal-date-picker-month-cell-selected'
                                                )}
                                                aria-label={`${i + 1}月`}
                                                onClick={() => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    sel && 'animal-date-picker-year-cell-selected'
                                                )}
                                                aria-label={`${y}年`}
                                                onClick={() => {
