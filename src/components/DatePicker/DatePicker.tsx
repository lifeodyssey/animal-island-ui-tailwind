                ...
                <div className="animal-date-picker-grid">
                    {buildCells(vDate).map((cell) => {
                        ...
                        const cls = cn(
                            ...
                            range && 'animal-date-picker-day-cell-range',
                                    ...
                                    {MONTHS.map((label, i) => {
                                        ...
                                        return (
                                            <button
                                                key={label}
                                                type="button"
                                                className={cn('animal-date-picker-month-cell', selected && 'animal-date-picker-month-selected')}
                                                aria-label={`${i + 1}月`}
                                                onClick={() => {
                                                    if (picker === 'month' && !range) {
                                    ...
                                    {yearCells.map((y) => {
                                        ...
                                        return (
                                            <button
                                                key={y}
                                                type="button"
                                                className={cn('animal-date-picker-year-cell', selected && 'animal-date-picker-year-selected')}
                                                aria-label={`${y}年`}
                                                onClick={() => {
