...
export const DatePicker: React.FC<DatePickerProps> = ({
                ...
                <div className="animal-datepicker-grid">
                    {buildCells(vDate).map((cell) => {
                        ...
                        const cls = [
                            ...
                            outside && 'animal-datepicker-day-cell-outside',
                            !range && isToday && 'animal-datepicker-day-cell-today',
                            selected && 'animal-datepicker-day-cell-selected',
                            rangeStartCell && 'animal-datepicker-day-cell-range-start',
                            rangeEndCell && 'animal-datepicker-day-cell-range-end',
                            inRange && 'animal-datepicker-day-cell-in-range',
                            disabledCell && 'animal-datepicker-day-cell-disabled',
                        ]
                            .filter(Boolean)
                            .join(' ');
                        return (
    ...
    return (
        <div
            ref={wrapperRef}
            className={['animal-datepicker-wrapper', disabled && 'animal-datepicker-wrapper-disabled', className].filter(Boolean).join(' ')}
            style={style}
        ...
        >
            ...
            {open && (
                <div
                    ...
                    className={`animal-datepicker-panel ${range ? 'animal-datepicker-panel-range' : ''} ${
                                    ...
                                    {MONTHS.map((label, i) => {
                                        ...
                                        return (
                                            <button
                                                key={label}
                                                type="button"
                                                className={`animal-datepicker-month-cell ${selected ? 'animal-datepicker-month-cell-selected' : ''}`}
                                                aria-label={`${i + 1}月`}
                                                onClick={() => {
                                                    if (picker === 'month' && !range) {
                                    ...
                                    {yearCells.map((y) => {
                                        ...
                                        return (
                                            <button
                                                key={y}
                                                type="button"
                                                className={`animal-datepicker-year-cell ${selected ? 'animal-datepicker-year-cell-selected' : ''}`}
                                                aria-label={`${y}年`}
                                                onClick={() => {
