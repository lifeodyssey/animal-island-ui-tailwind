...
> {
    ...
    /** Background color (only applies when variant='bordered'); 'white' is the default with no color. */
    color?: ImageColor;
    /** Frame type: 'default' uses card-style large shadow + large border-radius; 'bordered' uses border soft shadow + small border-radius. Defaults to 'default'. */
