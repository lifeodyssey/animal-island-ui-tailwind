...
export const TimePicker: React.FC<TimePickerProps> = ({
    ...
    return (
        <div
            ref={wrapperRef}
            className={cn('animal-timepicker-wrapper', disabled && 'animal-timepicker-wrapper-disabled', className)}
            style={style}
        ...
        >
            ...
            {open && (
                <div
                    ...
                    aria-label="选择时间"
                    className={cn(
                        'animal-timepicker-panel',
                        !hasSeconds(format) && 'animal-timepicker-panel-no-seconds',
                ...
                >
                    <div className="animal-timepicker-columns">
                        <div className="animal-timepicker-column">
                            <div className="animal-timepicker-column-title">时</div>
                            <div ref={hourListRef} className="animal-timepicker-column-list">
                                {hours.map((h) => (
                                    <button
                                        key={h}
                                        type="button"
                                        className={cn('animal-timepicker-option', base.h === h && 'animal-timepicker-option-selected')}
                                        aria-label={`${h} 时`}
                        ...
                        <div className="animal-timepicker-column">
                            <div className="animal-timepicker-column-title">分</div>
                            <div ref={minuteListRef} className="animal-timepicker-column-list">
                                {minutes.map((m) => (
                                    <button
                                        key={m}
                                        type="button"
                                        className={cn('animal-timepicker-option', base.m === m && 'animal-timepicker-option-selected')}
                                        aria-label={`${m} 分`}
                        ...
                        {seconds.length > 0 && (
                            <div className="animal-timepicker-column">
                                <div className="animal-timepicker-column-title">秒</div>
                                <div ref={secondListRef} className="animal-timepicker-column-list">
                                    {seconds.map((s) => (
                                        <button
                                            key={s}
                                            type="button"
                                            className={cn('animal-timepicker-option', base.s === s && 'animal-timepicker-option-selected')}
                                            aria-label={`${s} 秒`}
                    ...
                    <div className="animal-timepicker-footer">
                        <button
                            type="button"
                            className="animal-timepicker-footer-btn"
                            onClick={setNow}
                            onMouseDown={(e) => e.preventDefault()}
                        >
                            此刻
