...
describe('Button', () => {
    ...
    it('loading 状态点击不触发 onClick（业务约定）', () => {
        ...
        // Our implementation guards in the JS click handler (returns early when loading),
        // which is stricter than upstream's CSS pointer-events:none-only approach.
        // fireEvent bypasses CSS but our JS guard still prevents the callback.
