...
describe('Tag', () => {
    ...
    describe('color', () => {
        it('color=default 不应用任何 color 类', () => {
            ...
            const root = container.firstChild as HTMLElement;
            // No color-specific class; only base, size, and variant classes
            expect([...root.classList]).toEqual(['animal-tag', 'animal-tag-medium', 'animal-tag-solid']);
        });
    ...
    describe('closable', () => {
        ...
        it('disabled 状态下点击关闭按钮不触发 onClose', () => {
            ...
            // fireEvent bypasses pointer-events; handleClose guards with if (disabled)
            fireEvent.click(btn);
