...
export interface TagProps {
    ...
    size?: TagSize;
    /** solid 填充、outlined 描边、dashed 虚线 */
    variant?: TagVariant;
    color?: TagColor;
    closable?: boolean;
...
// Color+variant combo. Falls back to base color class when the specific combo isn't defined.
const colorClass = (color: TagColor, variant: TagVariant): string => {
