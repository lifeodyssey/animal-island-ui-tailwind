...
describe('Tag', () => {
    ...
    describe('color', () => {
        it('color=default 不应用任何 color 类', () => {
            ...
            const root = container.firstChild as HTMLElement;
            // Only size and variant classes should be present; no color-specific class.
            const colorPattern = /animal-tag-(?:app-|purple|brown|lime-green|yellow-green|warm-peach-pink)/;
            expect(root.className).not.toMatch(colorPattern);
        });
