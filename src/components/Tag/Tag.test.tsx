...
describe('Tag', () => {
    ...
    describe('color', () => {
        ...
        it('color=app-pink + solid 应用 animal-tag-color-app-pink-solid 类', () => {
            const { container } = render(
        ...
        it('color=purple + outlined 应用 animal-tag-color-purple-outlined 类', () => {
            const { container } = render(
        ...
        it('color=app-blue + dashed 应用 animal-tag-color-app-blue-dashed 类', () => {
            const { container } = render(
