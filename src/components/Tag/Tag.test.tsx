...
describe('Tag', () => {
    ...
    describe('color', () => {
        ...
        it('color=app-pink + soft 应用 color-app-pink-soft 类', () => {
            ...
            expect(container.firstChild).toHaveClass('animal-tag-color-app-pink-soft');
        });
        ...
        it('color=app-green + soft 应用 color-app-green-soft 类', () => {
            ...
            expect(container.firstChild).toHaveClass('animal-tag-color-app-green-soft');
        });
    });
    ...
    describe('clickable', () => {
        it('提供 onClick 后标签渲染为 role=button 且可点击', () => {
            ...
            expect(tag).toHaveClass('animal-tag-is-clickable');
        ...
        it('disabled 状态下不响应 onClick', () => {
            ...
            const root = container.firstChild as HTMLElement;
            expect(root).toHaveClass('animal-tag-is-disabled');
    ...
    describe('disabled', () => {
        it('应用 animal-tag-is-disabled 类', () => {
            const { container } = render(<Tag disabled>x</Tag>);
            expect(container.firstChild).toHaveClass('animal-tag-is-disabled');
        });
    });
