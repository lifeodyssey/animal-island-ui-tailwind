...
const SizeChanger: React.FC<{
...
}> = ({ value, options, disabled, variant = 'orange', onChange }) => {
    ...
    return (
        <div className="animal-pagination-size-changer" ref={ref}>
            <button
                type="button"
                className={cn('animal-pagination-size-trigger', open && `animal-pagination-size-trigger-open animal-pagination-size-trigger-open-${variant}`)}
                disabled={disabled}
                ...
                <ul className="animal-pagination-size-list" role="listbox" aria-label="选择每页条数">
                    {options.map((opt) => (
                        <li
                            ...
                            className={cn('animal-pagination-size-option', opt === value && 'animal-pagination-size-option-active')}
                            onClick={() => {
                                setOpen(false);
