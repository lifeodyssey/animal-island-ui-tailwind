...
describe('Footer', () => {
    it('默认 type=tree', () => {
        ...
        expect(root).toHaveClass('animal-footer-tree');
    });
    ...
    it('type=sea 不带 tree 类（sea 由默认背景实现）', () => {
        ...
        const root = container.firstChild as HTMLElement;
        expect(root).toHaveClass('animal-footer');
        expect(root).not.toHaveClass('animal-footer-tree');
    });
    ...
    it('默认 seamless=true 添加 seamless 类', () => {
        const { container } = render(<Footer />);
        const root = container.firstChild as HTMLElement;
        expect(root).toHaveClass('animal-footer-seamless');
    });
    ...
    it('seamless={false} 关闭无缝拼接', () => {
        ...
        const root = container.firstChild as HTMLElement;
        expect(root).not.toHaveClass('animal-footer-seamless');
    });
});
