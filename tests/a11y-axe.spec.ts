...
const stories = [
    ...
    { name: 'Tag', url: '/iframe.html?id=regression-parity-new-components--tag-stable&viewMode=story' },
    { name: 'Progress', url: '/iframe.html?id=regression-parity-new-components--progress-stable&viewMode=story' },
